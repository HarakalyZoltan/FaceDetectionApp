...
//        Button toggle = findViewById(R.id.face_detection_camera_toggle_button);
        ...
        //Setup out cameraView from our library
    ...
    private void detectFaces(List<FirebaseVisionFace> firebaseVisionFaces, Bitmap bitmap) {
        ...
        for (int i = 0 ; i < firebaseVisionFaces.size(); i++) {
            ...
            if(face.getLandmark(FirebaseVisionFaceLandmark.LEFT_EYE) != null) {
                ...
                //Now we have our left eye, we draw a circle
                assert leftEye != null;
                canvas.drawCircle(
            ...
            if(face.getLandmark(FirebaseVisionFaceLandmark.RIGHT_EYE) != null) {
                ...
                //Now we have our right eye, we draw a circle
                ...
                .addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
                    ...
                    public void onSuccess(List<FirebaseVisionFace> firebaseVisionFaces) {
                        ...
                        for (FirebaseVisionFace face : firebaseVisionFaces) {
                            //Get all the points
                            List<FirebaseVisionPoint> faceCountours = face.getContour(
                                    FirebaseVisionFaceContour.FACE
                            ).getPoints();
                            for (int i = 0; i < faceCountours.size(); i++) {
                                FirebaseVisionPoint faceCountour = null;
                                if (i != (faceCountours.size() - 1)) {
                                    faceCountour = faceCountours.get(i);
                                    canvas.drawLine(faceCountour.getX(),
                                            faceCountour.getY(),
                                            faceCountours.get(i + 1).getX(),
                                            faceCountours.get(i + 1).getY(),
                                            linePaint);
                                }else {
                                    canvas.drawLine(faceCountour.getX(),
                                            faceCountour.getY(),
                                ...
                                canvas.drawCircle(faceCountour.getX(),
                                        faceCountour.getY(),
                                        4f,
                                        dotPaint);
                            }// end inner loop
                            ...
                            for (int i = 0; i < leftEyeContours.size(); i++) {
                                ...
                                if (i != (leftEyeContours.size() - 1)){
                                    canvas.drawLine(contour.getX(), contour.getY(), leftEyeContours.get(i + 1).getX(),
                                            leftEyeContours.get(i + 1).getY(), linePaint);
                                }else {
                            ...
                            for (int i = 0; i < rightEyeContours.size(); i++) {
                                ...
                                if (i != (rightEyeContours.size() - 1)){
                                    canvas.drawLine(contour.getX(), contour.getY(), rightEyeContours.get(i + 1).getX(),
                                            rightEyeContours.get(i + 1).getY(), linePaint);
                                }else {
                            ...
                            for (int i = 0; i < upperLipBottomContour.size(); i++) {
                                ...
                                if (i != (upperLipBottomContour.size() - 1)){
                                    canvas.drawLine(contour.getX(), contour.getY(), upperLipBottomContour.get(i + 1).getX(),
                                            upperLipBottomContour.get(i + 1).getY(), linePaint);
                                }
                                canvas.drawCircle(contour.getX(), contour.getY(), 4f, dotPaint);
                            }
                            ...
                            for (int i = 0; i < lowerLipTopContour.size(); i++) {
                                ...
                                if (i != (lowerLipTopContour.size() - 1)){
                                    canvas.drawLine(contour.getX(), contour.getY(), lowerLipTopContour.get(i + 1).getX(),
                                            lowerLipTopContour.get(i + 1).getY(), linePaint);
                                }
                                canvas.drawCircle(contour.getX(), contour.getY(), 4f, dotPaint);
                            }
                            ...
                            for (int i = 0; i < lowerLipBottomContour.size(); i++) {
                                ...
                                if (i != (lowerLipBottomContour.size() - 1)){
                                    canvas.drawLine(contour.getX(), contour.getY(), lowerLipBottomContour.get(i + 1).getX(),
                                            lowerLipBottomContour.get(i + 1).getY(), linePaint);
                                }
                                canvas.drawCircle(contour.getX(), contour.getY(), 4f, dotPaint);
                            }
                            ...
                            for (int i = 0; i < noseBridgeContours.size(); i++) {
                                ...
                                if (i != (noseBridgeContours.size() - 1)) {
                                    canvas.drawLine(contour.getX(), contour.getY(), noseBridgeContours.get(i + 1).getX(),
                                            noseBridgeContours.get(i + 1).getY(), linePaint);
                                }
                                canvas.drawCircle(contour.getX(), contour.getY(), 4f, dotPaint);
                            }
                            ...
                            for (int i = 0; i < noseBottomContours.size(); i++) {
                                ...
                                if (i != (noseBottomContours.size() - 1)) {
                                    canvas.drawLine(contour.getX(), contour.getY(), noseBottomContours.get(i + 1).getX(),
                                            noseBottomContours.get(i + 1).getY(), linePaint);
                                }
                                canvas.drawCircle(contour.getX(), contour.getY(), 4f, dotPaint);
                            }
